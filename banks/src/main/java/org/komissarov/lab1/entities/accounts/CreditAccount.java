...
/**
 * This class represents a credit account in a bank.
 * It implements the IAccount interface and provides the necessary methods for managing a credit account.
 */
